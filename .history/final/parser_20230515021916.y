...
%type <nd_obj> externe externs main liste_instructions liste_declarations declaration saut selection tableu liste_declarateurs declarateur liste_expressions returne appel datatype instruction1 arithmetic relop programme else instruction binary_op
...
;
saut	:	
		BREAK ';'{$$.nd=faire_noeud(NULL,NULL,"break");$$.nd_dot=faire_noeud_lcrs(NULL,NULL);}
