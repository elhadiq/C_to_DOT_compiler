...
$5.nd_dot = faire_noeud_lcrs(NULL, NULL, "bloc","","");
$$.nd_dot = $1.nd_dot;
...
{sprintf(buff,"%s, %s",$2.nom,$1.nom);
$$.nd_dot=faire_noeud_lcrs(NULL, NULL, buff,"invtrapezium","");}
;
...
void afficher_les_dependances_dot_lcrs(FILE* f,struct noeud_lcrs *tree) {
	struct noeud_lcrs* current_chilid=tree;
		if (current_chilid->left_child){
			current_chilid=tree->left_child;
