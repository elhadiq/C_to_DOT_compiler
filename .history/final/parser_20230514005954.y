...
expression	:	
	...
	$$.nd_dot=faire_noeud($1.nd_dot,$3.nd_dot,buff);} 
	|	MOINS expression {$$.nd=$2.nd;}
	|	CONSTANTE { ajouter('C'); }
	{struct noeud* tmp=faire_noeud(NULL,NULL,$1.nom); $$.nd=tmp;sprintf(buff,"label=%s",$1.nom) ;$$.nd_dot=faire_noeud_lcrs(NULL,NULL,$1.nom);}
	|	variable {$$.nd=$1.nd;}
...
expression: expression arithmetic expression { 
	...
	$$.nd_dot=faire_noeud_lcrs($1.nd,NULL, buff); 
}
| valeur {
strcpy($$.nom, $1.nom);
strcpy($$.type, $1.type); 
