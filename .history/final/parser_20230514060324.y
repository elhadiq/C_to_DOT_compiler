...
| instruction1 ';' { $$.nd = $1.nd; $$.nd_dot=faire_noeud(NULL,NULL,"label=inst1");}
| appel {$$.nd=$1.nd;$$.nd_dot=faire_noeud(NULL,NULL,"label=inst1");}
|declaration {$$.nd_dot=faire_noeud(NULL,NULL,"label=inst1");}
;
