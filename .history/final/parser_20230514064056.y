...
if(strncmp(buff,"dec10",5)!=0)
$1.nd_dot->right_sibling=$2.nd_dot;
$$.nd_dot=$1.nd_dot;
}
	| instruction {int n=strncmp(buff,"decq10",5);if(n!=0){sprintf(buff,"label=dec%d",n);$$.nd_dot=faire_noeud_lcrs(NULL,NULL,"label=dec10dec");};}
	|
;
instruction:
...
| instruction1 ';' { $$.nd = $1.nd; $$.nd_dot=faire_noeud_lcrs(NULL,NULL,"label=ins1");}
| appel {$$.nd=$1.nd;$$.nd_dot=faire_noeud_lcrs(NULL,NULL,"label=appel10");}
|declaration {$$.nd_dot=faire_noeud_lcrs(NULL,NULL,"label=dec");strcpy(buff,"dec10");}
;
