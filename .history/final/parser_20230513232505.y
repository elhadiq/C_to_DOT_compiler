...
$5.nd_dot->right_sibling=$6.nd_dot;
head_dot=$$.nd_dot;
} 
| externs programme {
	$$.nd=$2.nd;
...
expression	:	
	...
	|	expression binary_op expression %prec OP {$$.nd=faire_noeud($1.nd,$3.nd,$2.nom);sprintf(buff,"label=%s",$2.nom);$$.nd_dot=faire_noeud($1.nd_dot,$3.nd_dot,$2.nom);} 
