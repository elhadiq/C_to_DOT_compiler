...
expression	:	
	...
	{$$.nd=faire_noeud($1.nd,$3.nd,$2.nom);sprintf(buff,"label=%s",$2.nom);$$.nd_dot=faire_noeud($1.nd_dot,$3.nd_dot,buff);} 
...
expression: expression arithmetic expression { 
	...
	$1.nd->right_sibling=$2.nd_dot;
	$$.nd_dot=faire_noeud_lcrs($1.nd, $3.nd, $2.nom); 
}
