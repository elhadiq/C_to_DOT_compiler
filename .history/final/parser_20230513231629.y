...
%type <nd_obj> externe externs main liste_instructions liste_declarations declaration liste_declarateurs declarateur liste_expressions returne appel datatype instruction1 arithmetic relop programme else return instruction binary_op
