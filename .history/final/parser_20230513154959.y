...
%type <nd_obj> externe externs main liste_instructions liste_declarateurs liste_expressions returne appel datatype instruction1 arithmetic relop programme else instruction binary_op
