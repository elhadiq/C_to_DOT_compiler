...
valeur: CONSTANTE 
{
sprintf(code3v[_3adr_index],$1.nom);
strcpy($$.nom, $1.nom);
 strcpy($$.type, "int");
 ajouter('C'); 
 $$.nd = faire_noeud(NULL, NULL, $1.nom); 
...
| IDENTIFICATEUR { sprintf(code3v[_3adr_index],$1.nom);strcpy($$.nom, $1.nom); char *id_type = retrurner_type($1.nom); strcpy($$.type, id_type); verefier_declaration($1.nom); $$.nd = faire_noeud(NULL, NULL, $1.nom); }
;
