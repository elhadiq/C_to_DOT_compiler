...
%type <nd_obj> externe externs main liste_fonctions fonction liste_instructions liste_declarations declaration selection tableu liste_declarateurs declarateur liste_expressions returne appel datatype instruction1 arithmetic relop programme else instruction binary_op
...
liste_fonctions	:	
		...
		{$$.nd=faire_noeud($1.nd,$2.nd,"fonctions");$$.nd=faire_noeud($1.nd,$2.nd,"fonctions");}
