...
|  		 {
			$$.nd=faire_noeud(NULL,NULL,"fct");
			$$.nd_dot=faire_noeud_lcrs(NULL,NULL,"label=fonction");
		 }
;
declaration	:	
...
fonction	:	
		...
		$$.nd_dot=faire_noeud_lcrs(faire_noeud_lcrs($5.nd_dot, NULL, "label=BLOC"), NULL, strTmp);
		 }
