...
%type <nd_obj> programme liste_fonctions fonction affectation variable expression 
%type <nd_obj> type liste_instructions instruction iteration selection saut appel bloc 
...
bloc	:	
		...
		{$$.nd=faire_noeud($1.nd,$2.nd,"BLOC");
		$$.nd_dot=faire_noeud($2.nd_dot,NULL,"label=BLOC")
		}
;
appel	:	
...
variable	:	
		...
		$$.nd_dot=faire_noeud_lcrs(NULL,NULL,concatener());
		}
	|	variable '[' expression ']' 
;
expression	:	
	...
	|	CONSTANTE {ajouter('C');}
	|	variable
	|	IDENTIFICATEUR {verefier_declaration($1.nom);} '(' liste_expressions ')'
;
liste_expressions	:	
