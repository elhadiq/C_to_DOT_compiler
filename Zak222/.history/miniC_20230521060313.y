...
%left <nd_obj> PLUS MOINS
%left <nd_obj> MUL DIV
%left <nd_obj> LSHIFT RSHIFT
%left <nd_obj> BOR BAND
%left <nd_obj> LAND LOR
%nonassoc THEN
%nonassoc ELSE
%left OP
%left REL
...
;
affectation	:	
		variable { verefier_declaration($1.nom); }  '=' expression
;
bloc	:	
		'{' liste_declarations liste_instructions '}'
;
appel	:	
		IDENTIFICATEUR {verefier_declaration(yytext);}'(' liste_expressions ')' ';'
;
variable	:	
		IDENTIFICATEUR {sprintf($$.nom,$1.nom);}
	|	variable '[' expression ']'
;
expression	:	
		'(' expression ')'
