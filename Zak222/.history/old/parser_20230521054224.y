...
%type <nd_obj> externe liste_fonctions fonction nom_fonction liste_instructions liste_declarations declaration selection tableu liste_declarateurs declarateur liste_expressions returne appel datatype instruction1 arithmetic binary_comp programme else instruction binary_op
...
;
declarateur	:  IDENTIFICATEUR {ajouter('V'); strcpy($$.nom,strdup($1.nom));}
...
|NOT '(' condition ')' {$$.nd=faire_noeud($1.nd,NULL,"not");
