...
iteration	:	
	...
	{
		$$.nd=faire_noeud($4.nd,$6.nd,"While");
...
selection	:	
	...
	{$$.nd=faire_noeud(faire_noeud(NULL,NULL,$3.nom),$6.nd);
	$$.nd_dot=faire_noeud_lcrs(faire_noeud_lcrs(NULL,NULL,concatener("label=",$3.nom)),NULL,"label=CASE");
...
;
liste_expressions	:	
		expression ',' liste_expressions 
		{$$.nd=faire_noeud($1.nd,$3.nd,"expressions");
		$$.nd_dot=$1.nd_dot;
		$1.nd_dot->right_sibling=$3.nd_dot;
		}
	| expression
