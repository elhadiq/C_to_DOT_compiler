...
%type <nd_obj> programme liste_fonctions affectation variable expression
...
programme	:	
		...
		{$$.nd=faire_noeud($2,NULL,"programme");
		head=$$.nd;
		$$.nd_dot=faire_noeud_lcrs($2,NULL,"label=programme");
		head_dot=$$.nd_dot;}
;
liste_declarations	:	
...
liste_fonctions	:	
		fonction liste_fonctions 
		{
			...
			$$.nd_dot=faire_noeud_lcrs($1.nd,$2.nd_dot)
		}
|  
;
declaration	:	
