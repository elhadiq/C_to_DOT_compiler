...
%type <nd_obj> type liste_instructions instruction iteration selection saut appel bloc liste_declarations liste_instructions 
...
bloc	:	
		...
		{$$.nd=faire_noeud($2.nd,$3.nd,"BLOC");
		$$.nd_dot=faire_noeud($3.nd_dot,NULL,"label=BLOC")
		}
;
appel	:	
